...
import { projects, members, notifications, analyticsData } from "@/data/mockData";
...
export default function Dashboard({ onSectionChange }: DashboardProps) {
  const stats = [
    { label: "Активных задач", value: "37", delta: "+4 за неделю", icon: "CheckSquare", color: "#6366f1" },
    { label: "В работе", value: "15", delta: "3 просрочены", icon: "Clock", color: "#8b5cf6" },
    { label: "Участников", value: "6", delta: "2 онлайн", icon: "Users", color: "#06b6d4" },
    { label: "Выполнено", value: "89%", delta: "↑ 12% к прошлой неделе", icon: "TrendingUp", color: "#10b981" },
  ];
            ...
            {lastVelocity.map((v, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-1.5">
                ...
                <div
                  ...
                  style={{
                    height: `${(v / maxV) * 88}px`,
                    background: i === lastVelocity.length - 1
